...
async def update_staff_contact(staffno: str, updates: StaffUpdate, request: Request):
    args = [staffno, updates.salary, updates.telephone, updates.mobile, updates.email]
